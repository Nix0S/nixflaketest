...
with lib;
with lib.internal;
let cfg = config.elements.services.tailscale;
in
{
  options.elements.services.tailscale = with types; {
    ...
    assertions = [
      {
        ...
        message = "elements.services.tailscale.autoconnect.key must be set";
      }
    ];
