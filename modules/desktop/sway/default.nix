...
with lib.internal;
let
  cfg = config.elements.desktop.sway;
  term = config.elements.desktop.addons.term;
...
in
{
  options.elements.desktop.sway = with types; {
  ...
  config = mkIf cfg.enable {
    ...
    elements.home.configFile."sway/config".text =
