...
with lib;
with lib.internal;
let cfg = config.elements.hardware.audio;
in
{
  options.elements.hardware.audio = with types; {
  ...
  config = mkIf cfg.enable {
    ...
    services.pipewire = {
      ...
      media-session.config.alsa-monitor =
        mkAliasDefinitions options.elements.hardware.audio.alsa-monitor;
    ...
    elements.user.extraGroups = [ "audio" ];
